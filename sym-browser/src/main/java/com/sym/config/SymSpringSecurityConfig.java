...
class SymSpringSecurityConfig extends WebSecurityConfigurerAdapter {
     ...
     */
    @Autowired
    private AuthenticationSuccessHandler symSignInSuccessHandler;

    /**
     * 自定义登录失败后的处理类
     */
    @Autowired
    private AuthenticationFailureHandler symSignInFailedHandler;

    /**
     * 自定义退出登录成功后的处理类
     */
    @Autowired
    private LogoutSuccessHandler symLogoutSuccessHandler;
     ...
     */
    @Autowired
    private SymAuthorizationConfigManager symAuthorizationConfigManager;
